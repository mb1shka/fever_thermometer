      ...
      onTap: () => Navigator.push(
        ...
        MaterialPageRoute(
          builder: (_) => ShowMeasurementDetails(
              ...
              health: measurement.health.toString(),
              symptoms: measurement.symptoms,
              notes: measurement.notes.toString(),
              dateTime: DateFormat('MMM d, jm').format(measurement.dateTime).toString(),
          ),
        )
      ),
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Padding(
              padding: const EdgeInsets.fromLTRB(0, 34, 24, 34),
